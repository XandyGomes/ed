...
export const quiz: QuizQuestion[] = [
  ...
  {
    id: "q2",
    enunciado: "Qual o problema de criar um objeto livre, sem passar por uma classe, em JavaScript?",
    opcoes: [
      "JavaScript não permite criar objetos livres",
      ...
      "Objetos livres são sempre mais lentos",
      "Objetos livres não podem ter métodos",
    ],
    correta: 1,
  ...
  {
    id: "q3",
    enunciado: "Em JavaScript, o que indica que um atributo de classe é privado?",
    opcoes: [
      "A palavra-chave private antes do nome",
      "O nome do atributo começar com #",
      "O atributo estar dentro do constructor",
      "Não existe atributo privado em JavaScript",
    ],
    correta: 1,
    explicacao: "Atributos privados em JavaScript são declarados com # antes do nome, e só podem ser acessados de dentro da própria classe.",
  },
  {
    id: "q4",
