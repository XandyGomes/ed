      ...
      <div className="mx-auto max-w-3xl px-4 pt-10">
        ...
        <div className="mb-8 flex flex-wrap gap-2">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--color-border)] px-3 py-1.5 text-xs font-medium text-[var(--color-muted)] transition-colors hover:border-[var(--color-foreground)]"
          >
